...
class PagerankCompute(private val elastic: Elastic) {
    ...
    private fun backRank(doc: PageType, backDocs: List<PageType>): Double {
    ...
    private fun getGlobalPagerankInfluenceOnDoc(doc: PageType, globalSinkRank: Double, allDocCount: Long): Double {
    ...
    suspend fun getPagerank(doc: PageType, globalSinkRank: Double, allDocCount: Long): Double = coroutineScope {
